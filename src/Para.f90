...
module Para
    ...
    integer          :: para_n_nt_Tn       = -1         ! [-1   ], # of nts in Tn, -1: by distance
    ...
    character(10) :: para_break_stap_rule  = "max"      ! [max, seed, mix, min, mid], Staple break rule
    ...
    integer   :: para_gap_min_region       = 8          ! [8 ], Min. gap dsDNA domain for the nick
    integer   :: para_gap_xover_nick       = 3          ! [3 ], Min. gap b/w Xover and nick

    integer   :: para_set_start_scaf       = 1          ! [1], Starting scaffold sequence number
    integer   :: para_pos_nick_scaf        = 1          ! [1, 2, 3], Edge section for the scaffold nick
    integer   :: para_max_break_scaf       = 0          ! [0, 7249], Maximum scaffold length
    integer   :: para_min_break_stap       = 20         ! [20], Minimum staple length
    integer   :: para_mid_break_stap       = 40         ! [40], Optimum staple length
    integer   :: para_max_break_stap       = 60         ! [60], Maximum staple length
